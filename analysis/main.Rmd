...
The case when we test if $H_1 : s_{true} \not = 0$ is called __two-sided alternative__ as it allows for $s_t$ to be either greater than zero or less than zero. The other case is working with a __one-sided alternative__, when we are indeed interested if a statistic is positive. $$H_0 : s_{true} \le 0 \\ H_1 : s_{true} \gt 0$$
